...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post temperatures_url, params: { temperature: { Device_id: @temperature.Device_id, unit: @temperature.unit, value: @temperature.value } }
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { Device_id: @temperature.Device_id, unit: @temperature.unit, value: @temperature.value } }
