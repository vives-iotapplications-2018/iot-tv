...
class DevicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device" do
    assert_difference('Device.count') do
      post devices_url, params: { device: { Location_id: @device.Location_id, dev-eui: @device.dev-eui } }
    end
  ...
  test "should update device" do
    patch device_url(@device), params: { device: { Location_id: @device.Location_id, dev-eui: @device.dev-eui } }
